...
class CompetitorAdmin(admin.ModelAdmin):
    list_display = ['name', 'sector', 'country', 'revenue_ytd', 'profit_ytd', 'market_share', 'is_our_company']
    list_filter = ['sector', 'country', 'is_our_company']
    search_fields = ['name']


@admin.register(SalesMetrics)
class SalesMetricsAdmin(admin.ModelAdmin):
    list_display = ['company', 'year', 'month', 'revenue', 'profit', 'units_sold']
    list_filter = ['year', 'month', 'company']


@admin.register(ProductSales)
class ProductSalesAdmin(admin.ModelAdmin):
    list_display = ['product', 'company', 'year', 'month', 'units_sold', 'revenue']
