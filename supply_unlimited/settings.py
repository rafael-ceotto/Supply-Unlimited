"""
Django settings for supply_unlimited project.
...
SECRET_KEY = 'django-insecure-qw^cdzq+&hvdab&5)twa_grf1c1k2si=re)_xi5#g^hhmulh8z'
...
ROOT_URLCONF = 'supply_unlimited.urls'
...
WSGI_APPLICATION = 'supply_unlimited.wsgi.application'
...
if os.getenv('USE_POSTGRESQL', 'False') == 'True':
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DB_NAME', 'supply_unlimited'),
